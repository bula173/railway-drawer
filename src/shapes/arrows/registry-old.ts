...
// Perimeter functions are registered with StyleRegistry in shapes/index.ts
// References here are by string name, not function objects
...
export function registerArrowShapes(): void {
  ...
  shapeRegistry.register({
    ...
    height: 60,
    style: {
      baseStyleNames: ['wideArrow'],
      shape: 'image',
      image: svgToDataUrl(svgArrows.wideArrow),
    },
  });
  ...
  shapeRegistry.register({
    ...
    height: 40,
    style: {
      baseStyleNames: ['thinArrow'],
      shape: 'image',
      image: svgToDataUrl(svgArrows.thinArrow),
    },
  });
  ...
  shapeRegistry.register({
    ...
    height: 60,
    style: {
      baseStyleNames: ['doubleArrow'],
      shape: 'image',
      image: svgToDataUrl(svgArrows.doubleArrow),
    },
  });
  ...
  shapeRegistry.register({
    ...
    height: 80,
    style: {
      baseStyleNames: ['splitArrow'],
      shape: 'image',
      image: svgToDataUrl(svgArrows.splitArrow),
    },
  });
  ...
  shapeRegistry.register({
    ...
    height: 100,
    style: {
      baseStyleNames: ['loopArrow'],
      shape: 'image',
      image: svgToDataUrl(svgArrows.loopArrow),
    },
  });
  ...
  shapeRegistry.register({
    ...
    height: 60,
    style: {
      baseStyleNames: ['chevronArrow'],
      shape: 'image',
      image: svgToDataUrl(svgArrows.chevronArrow),
    },
  });
